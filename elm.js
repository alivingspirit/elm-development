...
Elm.GuessField.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var update = F2(function (action,model) {    var _p0 = action;return _U.update(model,{guess: _p0._0});});
   ...
   var stringToAction = function (string) {
      ...
      var _p1 = result;
      if (_p1.ctor === "Ok") {
            return GuessChanged(GuessNumber(_p1._0));
         } else {
            return GuessChanged(Error(_p1._0));
         }
   };
   ...
   var view = F2(function (address,model) {
      var s = function () {
         var _p2 = model.guess;
         if (_p2.ctor === "GuessNumber") {
               var _p3 = _p2._0;
               return _U.cmp(_p3,model.answer) > 0 ? "Too High" : _U.cmp(_p3,model.answer) < 0 ? "Too Low" : "Correct";
            } else {
               return _p2._0;
            }
      }();
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.input,_U.list([A3($Html$Events.on,"input",$Html$Events.targetValue,makeMessage(address))]),_U.list([]))
...
Elm.Main.make = function (_elm) {
   ...
   var init = function (_p0) {    var _p1 = _p0;return A3(Model,Finished,$GuessField.init(0),$Maybe.Nothing);};
   var Started = {ctor: "Started"};
   var update = F2(function (_p2,model) {
      var _p3 = _p2;
      var _p4 = _p3._1;
      if (_p4.ctor === "GuessFieldAction") {
            return _U.update(model,{guessField: A2($GuessField.update,_p4._0,model.guessField)});
         } else {
            var time = $Basics.round(_p3._0);
            ...
            var _p6 = A2($Random.generate,randomIntGenerator,oldSeed);
   ...
   var view = function (model) {
      var appView = function () {
         ...
         if (_p7.ctor === "Finished") {
               return A2($Html.button,_U.list([A2($Html$Events.onClick,mailbox.address,NewGame)]),_U.list([$Html.text("New Game")]));
            } else {
               return A2($GuessField.view,guessFieldAddress,model.guessField);
            }
      }();
